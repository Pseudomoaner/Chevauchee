...
RootSim = '/home/omeacock/Documents/SPRruns/ContactRateRuns';
reconstructionRootName = 'Channel_1';
outputMatName = 'SimulationResults_F=%f.mat';
...
cellSettings.fire = 0.001; %Firing rate of cells
...
for fInd = 1:size(fs,2)
    ...
    fullMatOut = [RootSim,filesep,sprintf(outputMatName,fs(fInd))];
