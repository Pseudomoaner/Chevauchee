%Code to generate IBM simulations for Fig. SX. Single population, sweep
%over self-propulsion forces, large domain
clear all
close all
...
RootSim = '/home/omeacock/Documents/SPRruns/DiffusionConstRuns';
outputMatName = 'SimulationResults%f.mat';
...
for fInd = 1:size(fs,2)
    ...
    fullSprMatOut = fullfile(RootSim,sprintf(outputMatName,f));
